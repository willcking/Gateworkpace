...
class ChainNetworkNew():
    def __init__(self,
                 chain_name: str = None,
                 provider: str = None,
                 ) -> None:
        self.chain_name = chain_name
        # rpc_lst = read_nodes_from_config()
        # provider = random.choice(rpc_lst)
        #print(provider)
        self.chain_id = CHAIN_ID[chain_name]
        self.token = CONTRACT_ADDRESS[chain_name]
        ...
        self.gas_price = GAS_PRICE[chain_name]
